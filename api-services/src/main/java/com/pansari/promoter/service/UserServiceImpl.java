...
public class UserServiceImpl implements UserService {
    ...
    @Override
    @Transactional
    public int updateUser(int userid, String name, String username,  String password) throws CustomException {
        ...
        return userDao.updateUser(user, name, username, password);
    }
