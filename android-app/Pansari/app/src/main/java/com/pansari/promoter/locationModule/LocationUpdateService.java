...
import com.pansari.promoter.MainActivity;
...
//        stopForeground(true);
    ...
    private Notification getNotification() {
        ...
        CharSequence text = "Location Text";
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .addAction(R.drawable.common_google_signin_btn_icon_dark_focused, getString(R.string.launch_activity),
                        activityPendingIntent)
                .addAction(R.drawable.common_google_signin_btn_icon_disabled, getString(R.string.remove_location_updates),
